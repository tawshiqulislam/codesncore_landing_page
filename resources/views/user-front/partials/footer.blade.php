                                ...
                                <div class="widget nav-widget">
                                    ...
                                    <ul>
                                        @foreach ($userFooterQuickLinks as $quickLinkInfo)
                                            <li>
                                                {{-- new for CNC --}}
                                                @if($quickLinkInfo->title == 'Gallery')
                                                    <a href="{{ '/cnc/view-gallery' }}">Gallery</a>
                                                @elseif($quickLinkInfo->title == 'Download')
                                                    <a href="{{ '/cnc/view-downloads' }}">Download</a>
                                                @elseif($quickLinkInfo->title == 'Products')
                                                    <a href="{{ '/cnc/quote/products' }}">Products</a>
                                                @else
                                                    <a href="{{ '/cnc' . $quickLinkInfo->url }}">
                                    ...
                                    <ul class="contact-infos">
                                        ...
                                        @if (count($addresses) > 0)
                                            @foreach ($addresses as $address)
                                                <li>
                                                    <i class="far fa-map-marker-alt"></i> {{ $address }}
                                                </li>
                                            @endforeach
                                        @endif
                                    </ul>
