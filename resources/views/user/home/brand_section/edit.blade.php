                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="edit_distributor_no" name="distributor" value="no" class="custom-control-input">
                                <label class="custom-control-label" for="edit_distributor_no">{{ __('No') }}</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="edit_distributor_yes" name="distributor" value="yes" class="custom-control-input">
                                <label class="custom-control-label" for="edit_distributor_yes">{{ __('Yes') }}</label>
                            </div>
                        </div>
                        <p id="eerrdistributor" class="mt-2 mb-0 text-danger em"></p>
                    </div>
                </form>
            </div>
