                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 offset-lg-4 mt-2 mt-lg-0">
                            <a href="#" data-toggle="modal" data-target="#createModal"
                                ...
                                @if ($userBs->theme == 'home_eleven')
                                    {{ __('Add Donor/Distributor') }}
                                @else
                                    {{ __('Add Customer/Distributor') }}
                                @endif
                            </a>
                        </div>
                    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-4">
                                <div class="card-title d-inline-block">{{ __('All Distributors') }}</div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @if (count($distributor) == 0)
                                    <h3 class="text-center">{{ __('NO DISTRIBUTOR FOUND!') }}</h3>
                            @else
                                <div class="row">
                                    @foreach ($distributor as $brand)
                                        <div class="col-md-3">
                                            <div class="card">
                                                <div class="card-body">
                                                    <img src="{{ asset('assets/front/img/user/brands/' . $brand->brand_img) }}"
