...
@if (!empty($product->language) && $product->language->rtl == 1)
    @section('styles')
        <style>
            form input,
            form textarea,
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right d-inline-block"
                        href="{{ route('user.products_quote.index') . '?language=' . $product->language->code }}">
                ...
                <div class="card-body pt-5 pb-5">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                            <form id="ajaxForm" class="" action="{{ route('user.products_quote.update') }}" method="post"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 showImage mb-3">
                                                <img src="{{ isset($product->image) ? asset('assets/front/img/user/products/' . $product->image) : asset('assets/admin/img/noimage.jpg') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="btn-group d-block">
                                            <button type="button" class="btn btn-primary iconpicker-component"><i
                                                    class="{{ $product->icon }}"></i></button>
                                            <button type="button" class="icp icp-dd btn btn-primary dropdown-toggle"
                                                data-selected="fa-car" data-toggle="dropdown">
                                            </button>
                                            <div class="dropdown-menu"></div>
                                        </div>
                                        <input id="inputIcon" type="hidden" name="icon" value="{{ $product->icon }}">
                                        @if ($errors->has('icon'))
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control summernote" name="content" data-height="300">{{ replaceBaseUrl($product->content) }}</textarea>
                                    ...
                                    <div class="d-flext">
                                        ...
                                        <div class="radio mr-3">
                                            <label><input class="mr-1" type="radio" name="detail_page"
                                                    value="1"
                                                    {{ $product->detail_page == 1 ? 'checked' : '' }}>Enable</label>
                                        </div>
                                        <div class="radio">
                                            <label><input class="mr-1" type="radio" name="detail_page"
                                                    value="0"
                                                    {{ $product->detail_page == 0 ? 'checked' : '' }}>Disable</label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="meta_keywords"
                                        value="{{ $product->meta_keywords }}" data-role="tagsinput">
                                    <p id="errmeta_keywords" class="mb-0 text-danger em"></p>
                                </div>
                                <div class="form-group">
                                    <label for="">{{ __('Meta Description') }}</label>
                                    <textarea type="text" class="form-control" name="meta_description" rows="5">{{ $product->meta_description }}</textarea>
