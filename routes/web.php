...
Route::domain($domain)->group(function () {
    ...
    Route::group(['middleware' => 'setlang'], function () {
        ...
        Route::group(['prefix' => 'cnc'], function () {
    ...
    ******************* User Routes *************************
    ...
    Route::group(['prefix' => 'user', 'middleware' => ['auth', 'userstatus', 'Demo']], function () {
        ...
        // user gallery routes
        Route::get('/gallery', 'User\UserGalleryController@index')->name('user.gallery.index');
        Route::get('/gallery', 'User\UserGalleryController@index')->name('user.gallery.index');
        Route::post('/gallery', 'User\UserGalleryController@store')->name('user.gallery.store');
        Route::delete('/gallery/{id}', 'User\UserGalleryController@destroy')->name('user.gallery.destroy');
        ...
        Route::post('/contact/delete/{id}', 'User\ContactController@destroy')->name('user.contact.delete');
        ...
        //quote product routes // new for cnc
        Route::group(['prefix' => 'quote'], function () {
            Route::get('/products', 'User\QuoteProductController@index')->name('user.products_quote.index');
            Route::post('/products/store', 'User\QuoteProductController@store')->name('user.products_quote.store');
            Route::get('/products/{id}/edit', 'User\QuoteProductController@edit')->name('user.products_quote.edit');
            Route::post('/products/update', 'User\QuoteProductController@update')->name('user.products_quote.update');
            Route::post('/products/delete', 'User\QuoteProductController@delete')->name('user.products_quote.delete');
            Route::post('/products/bulk-delete', 'User\QuoteProductController@bulkDelete')->name('user.products_quote.bulk.delete');
            Route::post('products/featured', 'User\QuoteProductController@featured')->name('user.products_quote.feature');
            Route::post('/products/approve', 'User\QuoteProductController@approve')->name('user.products_quote.approve');
        });
...
if (array_key_exists('host', $parsedUrl)) {
    ...
    //if I dd($domain); here xyz.localhost:8000 I gate this "{domain}" and when I use localhost:8000/xyz I gate this "{username}"
}
Route::post('quote/products/req', 'Front\FrontendController@userQProduct_req')->name('quote_products.req'); // new for cnc
Route::group(['domain' => $domain, 'prefix' => $prefix], function () {
    ...
    Route::get('/view-gallery', 'Front\FrontendController@view_gallery')->name('user.gallery.view');
    Route::get('/view-downloads', 'Front\FrontendController@view_downloads')->name('user.downloads.view');
    ...
    // new for cnc
    Route::group(['prefix' => 'quote'], function () {
        Route::get('/products', 'Front\FrontendController@userQProducts')->name('front.user.q_products');
        Route::get('/products/{slug}/{id}', 'Front\FrontendController@userQProductsDetail')->name('front.user.q_products.detail');
        // Route::post('/products/req', 'Front\FrontendController@userQProduct_req')->name('quote_products.req');
    });
